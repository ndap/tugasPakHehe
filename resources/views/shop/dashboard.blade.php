...
<body>
  <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
    <a href="{{ route('logout') }}" id="logout-link" class="font-extrabold">logout</a>
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
              <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Lego</span>
              </div>
            </li>
          </ol>
        </nav>
        <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Lego</h2>
      </div>
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
       @foreach ($products as $product)
       <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-48">
          <a href="#">
            <img class="mx-auto h-full dark:hidden" src="{{ asset('/storage/products/'.$product->image) }}" alt="" />
            <img class="mx-auto hidden h-full dark:block" src="{{ asset('/storage/products/'.$product->image) }}" alt="" />
          </a>
        </div>
        <div class="pt-6">
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class=" font-extrabold leading-tight text-gray-900 dark:text-white">{{ "Rp " . number_format($product->price,2,',','.') }}</p>
